...
const std::map<int, const char*> _PartialKey_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kPartialKeyValues, _kPartialKeyNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const PartialKey::type& val) {
  std::map<int, const char*>::const_iterator it = _PartialKey_VALUES_TO_NAMES.find(val);
  if (it != _PartialKey_VALUES_TO_NAMES.end()) {
...
const std::map<int, const char*> _TablePermission_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kTablePermissionValues, _kTablePermissionNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TablePermission::type& val) {
  std::map<int, const char*>::const_iterator it = _TablePermission_VALUES_TO_NAMES.find(val);
  if (it != _TablePermission_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _SystemPermission_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(12, _kSystemPermissionValues, _kSystemPermissionNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const SystemPermission::type& val) {
  std::map<int, const char*>::const_iterator it = _SystemPermission_VALUES_TO_NAMES.find(val);
  if (it != _SystemPermission_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _NamespacePermission_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(9, _kNamespacePermissionValues, _kNamespacePermissionNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const NamespacePermission::type& val) {
  std::map<int, const char*>::const_iterator it = _NamespacePermission_VALUES_TO_NAMES.find(val);
  if (it != _NamespacePermission_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ScanType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kScanTypeValues, _kScanTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const ScanType::type& val) {
  std::map<int, const char*>::const_iterator it = _ScanType_VALUES_TO_NAMES.find(val);
  if (it != _ScanType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ScanState_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kScanStateValues, _kScanStateNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const ScanState::type& val) {
  std::map<int, const char*>::const_iterator it = _ScanState_VALUES_TO_NAMES.find(val);
  if (it != _ScanState_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _ConditionalStatus_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kConditionalStatusValues, _kConditionalStatusNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const ConditionalStatus::type& val) {
  std::map<int, const char*>::const_iterator it = _ConditionalStatus_VALUES_TO_NAMES.find(val);
  if (it != _ConditionalStatus_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _Durability_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kDurabilityValues, _kDurabilityNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const Durability::type& val) {
  std::map<int, const char*>::const_iterator it = _Durability_VALUES_TO_NAMES.find(val);
  if (it != _Durability_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _CompactionReason_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kCompactionReasonValues, _kCompactionReasonNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const CompactionReason::type& val) {
  std::map<int, const char*>::const_iterator it = _CompactionReason_VALUES_TO_NAMES.find(val);
  if (it != _CompactionReason_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _IteratorScope_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kIteratorScopeValues, _kIteratorScopeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const IteratorScope::type& val) {
  std::map<int, const char*>::const_iterator it = _IteratorScope_VALUES_TO_NAMES.find(val);
  if (it != _IteratorScope_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _TimeType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kTimeTypeValues, _kTimeTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
std::string to_string(const TimeType::type& val) {
  std::map<int, const char*>::const_iterator it = _TimeType_VALUES_TO_NAMES.find(val);
  if (it != _TimeType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
ColumnUpdate::~ColumnUpdate() noexcept {
}
...
ScanResult::~ScanResult() noexcept {
}
...
ScanColumn::~ScanColumn() noexcept {
}
...
IteratorSetting::~IteratorSetting() noexcept {
}
...
BatchScanOptions::~BatchScanOptions() noexcept {
}
...
KeyValueAndPeek::~KeyValueAndPeek() noexcept {
}
...
ConditionalUpdates::~ConditionalUpdates() noexcept {
}
...
ConditionalWriterOptions::~ConditionalWriterOptions() noexcept {
}
...
ActiveScan::~ActiveScan() noexcept {
}
...
ActiveCompaction::~ActiveCompaction() noexcept {
}
...
uint32_t ActiveCompaction::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeI32(static_cast<int32_t>(this->reason));
  xfer += oprot->writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->durability = static_cast<Durability::type>(ecast160);
          this->__isset.durability = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
WriterOptions::WriterOptions(const WriterOptions& other161) noexcept {
...
WriterOptions& WriterOptions::operator=(const WriterOptions& other162) noexcept {
...
UnknownScanner::~UnknownScanner() noexcept {
}
...
const char* UnknownScanner::what() const noexcept {
  try {
    std::stringstream ss;
...
UnknownWriter::~UnknownWriter() noexcept {
}
...
const char* UnknownWriter::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
NoMoreEntriesException::~NoMoreEntriesException() noexcept {
}
...
const char* NoMoreEntriesException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
AccumuloException::~AccumuloException() noexcept {
}
...
const char* AccumuloException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
AccumuloSecurityException::~AccumuloSecurityException() noexcept {
}
...
const char* AccumuloSecurityException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
TableNotFoundException::~TableNotFoundException() noexcept {
}
...
const char* TableNotFoundException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
TableExistsException::~TableExistsException() noexcept {
}
...
const char* TableExistsException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
MutationsRejectedException::~MutationsRejectedException() noexcept {
}
...
const char* MutationsRejectedException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
NamespaceExistsException::~NamespaceExistsException() noexcept {
}
...
const char* NamespaceExistsException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
NamespaceNotFoundException::~NamespaceNotFoundException() noexcept {
}
...
const char* NamespaceNotFoundException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
...
NamespaceNotEmptyException::~NamespaceNotEmptyException() noexcept {
}
...
const char* NamespaceNotEmptyException::what() const noexcept {
  try {
    std::stringstream ss;
    ss << "TException - service has thrown: " << *this;
    this->thriftTExceptionMessageHolder_ = ss.str();
