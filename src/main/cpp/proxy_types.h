...
class IteratorSetting : public virtual ::apache::thrift::TBase {
 public:
  ...
  IteratorSetting() noexcept
                  : priority(0),
                    name(),
                    iteratorClass() {
  }

  virtual ~IteratorSetting() noexcept;
  int32_t priority;
  std::string name;
...
class ScanOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  ScanOptions() noexcept
              : bufferSize(0) {
  }

  virtual ~ScanOptions() noexcept;
...
class BatchScanOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  BatchScanOptions() noexcept
                   : threads(0) {
  }

  virtual ~BatchScanOptions() noexcept;
  std::set<std::string>  authorizations;
...
class KeyValueAndPeek : public virtual ::apache::thrift::TBase {
 public:
  ...
  KeyValueAndPeek() noexcept
                  : hasNext(0) {
  }

  virtual ~KeyValueAndPeek() noexcept;
  KeyValue keyValue;
  bool hasNext;
...
class ConditionalUpdates : public virtual ::apache::thrift::TBase {
 public:
  ...
  ConditionalUpdates() noexcept {
  }

  virtual ~ConditionalUpdates() noexcept;
...
class ConditionalWriterOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  ConditionalWriterOptions() noexcept
                           : maxMemory(0),
                             timeoutMs(0),
                             threads(0),
                             durability(static_cast<Durability::type>(0)) {
  }

  virtual ~ConditionalWriterOptions() noexcept;
  int64_t maxMemory;
  int64_t timeoutMs;
  int32_t threads;
  std::set<std::string>  authorizations;
 ...
 public:
  ...
  ActiveScan() noexcept
             : client(),
               ...
               age(0),
               idleTime(0),
               type(static_cast<ScanType::type>(0)),
               state(static_cast<ScanState::type>(0)) {
  }

  virtual ~ActiveScan() noexcept;
  std::string client;
  std::string user;
  std::string table;
  int64_t age;
...
class ActiveCompaction : public virtual ::apache::thrift::TBase {
 public:
  ...
  ActiveCompaction() noexcept
                   : age(0),
                     outputFile(),
                     type(static_cast<CompactionType::type>(0)),
                     reason(static_cast<CompactionReason::type>(0)),
                     localityGroup(),
                     entriesRead(0),
                     entriesWritten(0) {
  }

  virtual ~ActiveCompaction() noexcept;
  KeyExtent extent;
  int64_t age;
...
class WriterOptions : public virtual ::apache::thrift::TBase {
 public:
  ...
  WriterOptions(const WriterOptions&) noexcept;
  WriterOptions& operator=(const WriterOptions&) noexcept;
  ...
  virtual ~WriterOptions() noexcept;
  int64_t maxMemory;
  int64_t latencyMs;
  int64_t timeoutMs;
  int32_t threads;
...
class UnknownScanner : public ::apache::thrift::TException {
 public:
  ...
  UnknownScanner() noexcept
                 : msg() {
  }

  virtual ~UnknownScanner() noexcept;
  std::string msg;
...
class UnknownWriter : public ::apache::thrift::TException {
 public:
  ...
  UnknownWriter() noexcept
                : msg() {
  }

  virtual ~UnknownWriter() noexcept;
  std::string msg;
...
class NoMoreEntriesException : public ::apache::thrift::TException {
 public:
  ...
  NoMoreEntriesException() noexcept
                         : msg() {
  }

  virtual ~NoMoreEntriesException() noexcept;
  std::string msg;
...
class AccumuloException : public ::apache::thrift::TException {
 public:
  ...
  AccumuloException() noexcept
                    : msg() {
  }

  virtual ~AccumuloException() noexcept;
  std::string msg;
...
class AccumuloSecurityException : public ::apache::thrift::TException {
 public:
  ...
  AccumuloSecurityException() noexcept
                            : msg() {
  }

  virtual ~AccumuloSecurityException() noexcept;
  std::string msg;
...
class TableNotFoundException : public ::apache::thrift::TException {
 public:
  ...
  TableNotFoundException() noexcept
                         : msg() {
  }

  virtual ~TableNotFoundException() noexcept;
  std::string msg;
...
class TableExistsException : public ::apache::thrift::TException {
 public:
  ...
  TableExistsException() noexcept
                       : msg() {
  }

  virtual ~TableExistsException() noexcept;
  std::string msg;
...
class MutationsRejectedException : public ::apache::thrift::TException {
 public:
  ...
  MutationsRejectedException() noexcept
                             : msg() {
  }

  virtual ~MutationsRejectedException() noexcept;
  std::string msg;
...
class NamespaceExistsException : public ::apache::thrift::TException {
 public:
  ...
  NamespaceExistsException() noexcept
                           : msg() {
  }

  virtual ~NamespaceExistsException() noexcept;
  std::string msg;
...
class NamespaceNotFoundException : public ::apache::thrift::TException {
 public:
  ...
  NamespaceNotFoundException() noexcept
                             : msg() {
  }

  virtual ~NamespaceNotFoundException() noexcept;
  std::string msg;
...
class NamespaceNotEmptyException : public ::apache::thrift::TException {
 public:
  ...
  NamespaceNotEmptyException() noexcept
                             : msg() {
  }

  virtual ~NamespaceNotEmptyException() noexcept;
  std::string msg;
