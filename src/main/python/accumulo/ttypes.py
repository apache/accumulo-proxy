    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.iteratorClass = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
...
class KeyExtent(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.tableId = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
...
class ActiveScan(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.client = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.localityGroup = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.I64:
...
class UnknownScanner(TException):
    ...
    def __init__(self, msg=None,):
        super(UnknownScanner, self).__setattr__('msg', msg)
...
class UnknownWriter(TException):
    ...
    def __init__(self, msg=None,):
        super(UnknownWriter, self).__setattr__('msg', msg)
...
class NoMoreEntriesException(TException):
    ...
    def __init__(self, msg=None,):
        super(NoMoreEntriesException, self).__setattr__('msg', msg)
...
class AccumuloException(TException):
    ...
    def __init__(self, msg=None,):
        super(AccumuloException, self).__setattr__('msg', msg)
...
class AccumuloSecurityException(TException):
    ...
    def __init__(self, msg=None,):
        super(AccumuloSecurityException, self).__setattr__('msg', msg)
...
class TableNotFoundException(TException):
    ...
    def __init__(self, msg=None,):
        super(TableNotFoundException, self).__setattr__('msg', msg)
...
class TableExistsException(TException):
    ...
    def __init__(self, msg=None,):
        super(TableExistsException, self).__setattr__('msg', msg)
...
class MutationsRejectedException(TException):
    ...
    def __init__(self, msg=None,):
        super(MutationsRejectedException, self).__setattr__('msg', msg)
...
class NamespaceExistsException(TException):
    ...
    def __init__(self, msg=None,):
        super(NamespaceExistsException, self).__setattr__('msg', msg)
...
class NamespaceNotFoundException(TException):
    ...
    def __init__(self, msg=None,):
        super(NamespaceNotFoundException, self).__setattr__('msg', msg)
...
class NamespaceNotEmptyException(TException):
    ...
    def __init__(self, msg=None,):
        super(NamespaceNotEmptyException, self).__setattr__('msg', msg)
