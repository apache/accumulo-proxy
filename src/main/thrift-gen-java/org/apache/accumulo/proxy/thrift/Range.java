...
public class Range implements org.apache.thrift.TBase<Range, Range._Fields>, java.io.Serializable, Cloneable, Comparable<Range> {
  ...
  public int compareTo(Range other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetStartInclusive(), other.isSetStartInclusive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetStopInclusive(), other.isSetStopInclusive());
    if (lastComparison != 0) {
      return lastComparison;
    }
